...
<!-- Add CSS for the cancel confirmation modal -->
<style>
  /* Modal Background */
  .modal-overlay {
    display: none;
      ...
      <div class="payment-detail-info">
        ...
        <div class="info-group">
          ...
          <span>
            ...
            echo ($metode === 'transfer_bank') ? 'Transfer Bank' : (($metode === 'e_wallet') ? 'E-Wallet' : (($metode === 'qris') ? 'QRIS' : ucfirst($metode)));
            ?>
          </span>
        </div>
            ...
            <div class="payment-upload-form">
              <form action="pembayaran_detail.php?ref=<?php echo $reference; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                  ...
                  <button type="button" class="btn btn-danger" id="btnCancelPayment">Batalkan Pembayaran</button>
                </div>
              </form>
            </div>
          </div>
      ...
      <?php elseif ($payment['status'] === 'berhasil'): ?>
        <div class="payment-card">
          ...
          <div class="payment-info-text success-text">
            ...
            <div class="form-actions">
              <a href="print_receipt.php?ref=<?php echo $reference; ?>" target="_blank" class="btn btn-primary">Cetak Bukti Pembayaran</a>
              <a href="layanan-pembayaran.php" class="btn btn-secondary">Kembali ke Daftar Pembayaran</a>
            </div>
          </div>
        </div>
      <?php elseif ($payment['status'] === 'gagal'): ?>
        <div class="payment-card">
          <div class="payment-header">
            <h3>Tindakan</h3>
          </div>

          <div class="payment-info-text error-text">
            <p>Pembayaran ini telah dibatalkan atau gagal diproses.</p>
            <p>Silakan lakukan pembayaran ulang untuk melunasi tagihan Anda.</p>

            <div class="form-actions">
              <a href="bayar.php" class="btn btn-primary">Bayar Ulang</a>
              <a href="layanan-pembayaran.php" class="btn btn-secondary">Kembali ke Daftar Pembayaran</a>
            </div>
          </div>
        </div>
...
<div id="cancelModal" class="modal-overlay">
  <div class="confirm-modal">
    ...
    <div class="modal-body">
      ...
      <p>Nomor Referensi: <span class="reference-highlight"><?php echo $reference; ?></span></p>
      <p>Pembatalan tidak dapat dibatalkan dan Anda harus membuat pembayaran baru untuk tagihan ini.</p>
    </div>
    <div class="modal-footer">
      <button class="btn-modal-cancel" id="btnCloseModal">Tidak, Kembali</button>
      <a href="pembayaran_detail.php?ref=<?php echo $reference; ?>&action=cancel&confirm=1" class="btn-modal-confirm">Ya, Batalkan Pembayaran</a>
    </div>
  </div>
</div>
