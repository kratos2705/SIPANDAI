...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // If no error during upload, insert into database
    if (!isset($_SESSION['error_message'])) {
        // Set publication date if status is published
        $tanggal_publikasi = ($status == 'published') ? 'NOW()' : 'NULL';
        
        // Insert berita
        $query = "INSERT INTO berita (judul, konten, thumbnail, kategori, tag, status, tanggal_publikasi, created_by, created_at, updated_at) 
                  VALUES (?, ?, ?, ?, ?, ?, " . $tanggal_publikasi . ", ?, NOW(), NOW())";
        
        $stmt = mysqli_prepare($koneksi, $query);
        
        if ($stmt) {
            mysqli_stmt_bind_param($stmt, "ssssssi", $judul, $konten, $thumbnail_path, $kategori, $tag, $status, $user_id);
            
            if (mysqli_stmt_execute($stmt)) {
                $berita_id = mysqli_insert_id($koneksi);
                ...
                $_SESSION['success_message'] = "Berita berhasil disimpan!";
                redirect('berita.php');
            } else {
                $_SESSION['error_message'] = "Gagal menyimpan berita: " . mysqli_error($koneksi);
            }
...
<div class="admin-content">
        ...
        <form action="" method="POST" enctype="multipart/form-data" id="newsForm">
            <div class="form-grid">
                ...
                <div class="form-group col-span-2">
                    ...
                    <textarea name="konten" id="konten" class="form-control editor" rows="10" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload">
                        ...
                        <div class="preview-container" id="thumbnailPreview">
                            <div class="no-preview">Pratinjau gambar</div>
                        </div>
                    </div>
                ...
                <div class="form-group col-span-2">
                    ...
                    <div class="radio-group">
                        ...
                        <label class="radio-option">
                            ...
                            <small>Langsung dipublikasikan di website</small>
                        </label>
                    </div>
                </div>
            </div>
    ...
    <!-- Tips Section -->
    <div class="info-card">
        <h3>Tips Menulis Berita</h3>
        <div class="tips-grid">
            <div class="tip-item">
                <div class="tip-icon">📝</div>
                <div class="tip-content">
                    <h4>Judul yang Menarik</h4>
                    <p>Buatlah judul yang singkat, jelas, dan menarik perhatian pembaca.</p>
                </div>
            </div>
            <div class="tip-item">
                <div class="tip-icon">📑</div>
                <div class="tip-content">
                    ...
                    <p>Gunakan paragraf pendek, subheading, dan poin-poin untuk membuat konten mudah dibaca.</p>
                </div>
            </div>
            <div class="tip-item">
                <div class="tip-icon">🔍</div>
                <div class="tip-content">
                    <h4>SEO</h4>
                    <p>Gunakan kata kunci di judul, konten, dan tag untuk meningkatkan penemuan di mesin pencari.</p>
                </div>
            </div>
            <div class="tip-item">
                <div class="tip-icon">📊</div>
                <div class="tip-content">
                    <h4>Media dan Data</h4>
                    <p>Sertakan gambar, tabel, atau grafik untuk mendukung informasi dalam berita.</p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    thumbnailInput.addEventListener('change', function() {
        ...
        if (this.files && this.files[0]) {
            ...
            thumbnailPreview.innerHTML = '<div class="no-preview">Pratinjau gambar</div>';
        }
    });
